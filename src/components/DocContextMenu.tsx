...
import { checkSpelling, SpellCheckResult } from '../utils/portugueseSpellChecker';
...
export const DocContextMenu: React.FC<DocContextMenuProps> = ({
  ...
  // Executa verificação ortográfica quando abre com texto selecionado
  useEffect(() => {
    if (isOpen && selectedText.trim()) {
      const result = checkSpelling(selectedText.trim());
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Seção do Corretor Ortográfico (Não-IA, Determinístico) */}
          <div className="pt-1">

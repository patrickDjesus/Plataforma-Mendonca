...
export const GlossaryWord: React.FC<GlossaryWordProps> = ({ term: _term, definition, children }) => {
  return (
    <Tooltip definition={definition} position="top">
      <span
        className="inline-block relative group/term px-1.5 py-0.5 mx-0.5 rounded-md font-semibold transition-all duration-200 cursor-pointer bg-[#EBF3EF]/80 hover:bg-[#CFE1D6]/90 text-[#1E3E30] dark:bg-[#15221B]/70 dark:hover:bg-[#22392D]/90 dark:text-[#52B788] border-b-2 border-[#2D5A46]/80 dark:border-[#52B788] shadow-2xs"
        title="Passe o mouse para ver o conceito"
      >
        {children}
        <span className="inline-block ml-0.5 text-[10px] text-[#2D5A46]/80 dark:text-[#52B788]/80 opacity-70 group-hover/term:opacity-100 transition-opacity">
          ✦
        </span>
      </span>
    </Tooltip>

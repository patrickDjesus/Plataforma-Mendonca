...
export const AuthScreen: React.FC<AuthScreenProps> = ({ onLoginSuccess }) => {
  ...
  const handleSkipLogin = () => {
    onLoginSuccess({
      ...
      email: 'visitante@mendonca.edu.br',
      avatar: 'EV',
    });
  };
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 mb-8">
                  ...
                  <button
                    ...
                    className="text-xs font-semibold text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1 cursor-pointer py-1 px-2.5 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-all"
                  >
                    <span>Pular login</span>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="pt-2 space-y-2.5">
                    ...
                    {/* Botão Simples para Pular o Login */}
                    <button
                      type="button"
                      onClick={handleSkipLogin}
                      className="w-full mt-1.5 py-2.5 px-4 rounded-2xl text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 bg-slate-50 dark:bg-slate-800/60 hover:bg-blue-50/60 dark:hover:bg-blue-950/30 border border-dashed border-slate-300 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-700 transition-all flex items-center justify-center gap-2 cursor-pointer"
                    >
                      <span>Pular login por enquanto (Acesso Direto)</span>
                      <ArrowRight className="w-3.5 h-3.5" />
                    </button>
                  </div>
                </form>
